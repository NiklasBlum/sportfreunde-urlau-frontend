    ...
    <>
      ...
      <Section className="bg-blue">
        ...
        <p className="text-red-tint text-body">
          ...
          und Ausdauerübungen zu rhythmischer Musik &ndash; jeder macht so viel
          und so gut er gerade kann.
        </p>
      </Section>
      ...
      <Section>
        ...
        <div className="bg-surface rounded-xl p-6 border border-black/6 ">
          <p className="text-body-xs text-muted">
            ...
            ca. 40 und 60 Jahren. Alle sind willkommen, die sich uns anschließen
            möchten.
          </p>

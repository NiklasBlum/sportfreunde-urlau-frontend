...
export default function AbteilungCard({
  ...
  return (
    ...
    >
      <div className="w-20 h-20 bg-[#f2eeeb] rounded-full flex items-center justify-center text-[1.4rem] mx-auto mb-[0.85rem] transition-colors duration-200 group-hover:bg-[rgba(192,17,31,0.08)]">
        {icon}
      </div>

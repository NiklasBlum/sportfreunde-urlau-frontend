        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-red-tint text-body max-w-130">
              Wir treffen uns immer mittwochs ab 19:30/20:00 Uhr in der Urlauer
              Dorfhalle. Unsere Gruppe freut sich über Neueinsteiger – komm
              einfach zum Schnuppern vorbei!
            </p>
          </div>

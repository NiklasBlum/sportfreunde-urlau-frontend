    ...
    <main id="main-content">
      ...
      <Section className="bg-blue">
        ...
        <p className="text-red-tint text-body max-w-xl">
          Fragen, Anregungen oder Interesse an einer Mitgliedschaft? Wir freuen
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {kontaktKarten.map(({ icon, label, lines, href, hrefLabel }) => (
                <div
                  key={label}
          ...
          <div>
            ...
            <p className="text-caption text-muted mt-4">
              Für abteilungsspezifische Anfragen wenden Sie sich bitte direkt an
              die jeweilige{" "}
              <Link
                href="/#abteilungen"

      ...
      <Section className="bg-surface border-t border-black/6">
        <article className="prose prose-sm ">
          ...
          <p className="text-body mb-4">
            Am 20.03.2026 haben 54 Vereinsmitglieder ihre Jahreshauptversammlung
            im kleinen Raum der Dorfhalle Urlau abgehalten.
          </p>
          ...
          <p className="text-body mb-4">
            ...
            erfolgreiches Jahr hinter uns haben. Brigitte Krug und Johann Peter
            haben die Kasse vorab geprüft und Martina wieder eine einwandfreie
            Führung bestätigt. Ebenso zeigen die verschiedenen
            ...
            hervor. Zum ersten Mal veranstalteten die Abteilung Kinderturnen und
            Eltern-Kindturnen einen Secondhand-Faschingsmarkt über die
            Hilfsorganisation „Aktion Hoffnung“. Der Erlös wurde an„Hoffnung
            Kindheit“ in Indien gespendet.
          </p>

          <p className="text-body mb-4">
            Unter der Leitung von Ortsvorsteher Sven Stöckle standen die Wahlen
            auf dem Programm. Hierbei wurde wieder Michael Tronsberg zum 1.
            Vorsitzenden, Simone Breins zur stellvertretenden Vorsitzenden und
            Hansi Bauer zum 2. stellvertretenden Vorsitzenden gewählt. Martina
            Dorn wurde als Kassiererin und Erika Peter als Schriftführerin
            bestätigt. Sandrina Fasser vervollständigt das Vorstandsteam als neu
            gewählte 2. Kassiererin. Neue Jugendvertreter der Sportfreunde sind
            Fabian Menig (Jugendleiter) und Benedikt Ziegerer (Jugendsprecher).
          </p>
